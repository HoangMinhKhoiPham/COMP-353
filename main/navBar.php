        ...
        <li class="nav-item active">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item" href="queryNine.php">Query No.9</a></li>
              <li><a class="dropdown-item" href="queryTen.php">Query No.10</a></li>
              <li><a class="dropdown-item" href="queryThirdteen.php">Query No.13</a></li>
              <li><a class="dropdown-item" href="queryFourteen.php">Query No.14</a></li>
              <li><a class="dropdown-item" href="querySeventeen.php">Query No.17</a></li>
